<template>
  <v-app>
      <v-card color="teal accent-3" dark class="d-flex flex-column">
        <v-img :src="image" :key="image" height="600" gradient="to bottom right, rgba(100,115,201,.75), rgba(25,32,72,.5)">      
  ...
  >
    ...
    >
      ...
      <v-row class="pt-0 d-flex justify-center">
        <v-img class="mr-5 shadow" max-width="7%" max-height="100%" src="https://images-apilist-fun.sfo2.cdn.digitaloceanspaces.com/the_sports_db_api.png">
        </v-img>
        <v-img class="mx-5 shadow2" max-width="10%" height="100%" src="./assets/newsapi.png">
        </v-img>
        <v-img class="ml-5 shadow" max-width="7%" max-height="100%" src="https://www.api-football.com/public/img/home1/hero-banner1.png">
        </v-img>
