...
<!--             tooltip section-->
             ...
             >
              ...
              <v-card v-if="selectedTeam.strDescriptionEN || selectedTeam.strTeamBanner" color="rgba(26, 35, 126, 0.5)" class="white--text text-left mx-sm-8 my-10 animated fadeIn" style="animation-delay: 500ms" :elevation="10">
              <img id="banner" :src="selectedTeam.strTeamBanner" class="v-picker--full-width mb-5 animated fadeIn" >

<!--             team description section-->
              <div class="py-8 px-8 text-justify">
                  <p v-if="!readMoreTeamDescActivated && selectedTeam.strDescriptionEN.length > 435"> {{selectedTeam.strDescriptionEN.slice(0, 435)}}...</p>
                  <p v-if="readMoreTeamDescActivated || selectedTeam.strDescriptionEN.length < 435" > {{selectedTeam.strDescriptionEN}}</p>
...
<!--              team info section-->
              <v-card color="rgba(26, 35, 126, 0.5)" :elevation="10" class="mx-sm-8 white--text animated fadeIn" style="animation-delay: 750ms">
                  <v-row>
                      <div class="mx-md-7 col-4 offset-md-0 offset-4 my-md-7 px-md-7 py-md-7">
                          <v-img v-if="selectedTeam.strTeamBadge" id="logo" :src="selectedTeam.strTeamBadge"></v-img>
                      </div>
                      <div class="col-md-7">
                          <v-row v-if="selectedTeam.strTeam">
                              <div class="col-md-4 col-6  text-right py-0">
                                  <p class="font-weight-black"> Team: </p>
                              </div>
                              <div class="col-md-8 col-6 text-left py-0">
                                  <p> {{selectedTeam.strTeam}} </p>
                              </div>
                          </v-row>
                          <v-row v-if="selectedTeam.intFormedYear && selectedTeam.intFormedYear != '0'">
                              <div class="col-md-4 col-6  text-right py-0">
                                  <p class="font-weight-black"> Formed: </p>
                              </div>
                              <div class="col-md-8 col-6 text-left py-0">
                                  <p> {{selectedTeam.intFormedYear}} </p>
                              </div>
                          </v-row>
                          <v-row v-if="selectedTeam.strLeague && !selectedTeam.strLeague.startsWith('_')">
                              <div class="col-md-4 col-6  text-right py-0">
                                  <p class="font-weight-black"> League: </p>
                              </div>
                              <div class="col-md-8 col-6 text-left py-0">
                                  <p> {{selectedTeam.strLeague}} </p>
                              </div>
                          </v-row>
                          <v-row v-if="selectedTeam.strStadium">
                              <div class="col-md-4 col-6  text-right py-0">
                                  <p class="font-weight-black"> Stadium: </p>
                              </div>
                              <div class="col-md-8 col-6 text-left py-0">
                                  <p> {{selectedTeam.strStadium}} </p>
                              </div>
                          </v-row>
                          <v-row v-if="selectedTeam.strCountry">
                              <div class="col-md-4 col-6  text-right py-0">
                                  <p class="font-weight-black"> Country: </p>
                              </div>
                              <div class="col-md-8 col-6 text-left py-0">
                                  <p> {{selectedTeam.strCountry}} </p>
                              </div>
                          </v-row>
                      </div>
                  </v-row>
...
<!--              team players section-->
              <v-card v-if="teamPlayers" color="rgba(26, 35, 126, 0.5)" class="text-left mx-sm-8 my-10 animated fadeIn" style="animation-delay: 1s" :elevation="10">
                  ...
                  <v-row class="pa-4" justify="space-between">
                      ...
                      <div class="col-lg-6 col-md-5 col-12 text-center pl-0">
                              ...
                              <v-card v-else :key="selectedPlayer.id" class="my-10 animated flipInY" flat>
                                  <v-card-text>
                                      <v-avatar size="100">
                                          <v-img :src="selectedPlayer.strCutout" v-if="selectedPlayer.strCutout" class="mb-6"></v-img>
                                      </v-avatar>
                                  ...
                                  <v-divider></v-divider>
                                  <div class="my-5">
                                      <v-row class="pa-0" v-if="selectedPlayer.dateBorn">
                                          <div class="offset-1 offset-md-0 col-5  pa-0 text-right font-regular mr-4 mb-2" tag="strong" cols="6">Date of birth:</div>
                                          <div class="col-5 pa-0 text-left font-weight-light">{{selectedPlayer.dateBorn}}</div>
                                      </v-row>
                                      <v-row class="pa-0" v-if="selectedPlayer.strNationality">
                                      ...
                                      <v-row class="pa-0" v-if="selectedPlayer.strNumber">
                                      ...
                                      <v-row class="pa-0" v-if="selectedPlayer.strPosition">
...
<!--              team events section-->
              <v-card v-if="teamEvents" color="rgba(26, 35, 126, 0.5)" class="col-md-6 offset-md-3 pa-0 animated fadeIn" style="animation-delay: 1250ms" :elevation="10">
                  <v-card-title class="white--text headline">
                      Coming events
                  </v-card-title>
                  <v-list two-line>
                          ...
                          <template v-for="(teamEvent, eventIndex) in teamEvents">
                              <v-list-item :key="eventIndex">
                                  <v-list-item-content class="text-left">
                                      ...
                                      <v-list-item-subtitle v-if="teamEvent.strLeague" class="text--primary" v-text="teamEvent.strLeague"></v-list-item-subtitle>
                                  </v-list-item-content>
                                  <v-list-item-action>
...
<!--             Carousel section -->
              <v-card color="rgba(26, 35, 126, 0.5)" class="white--text text-left mx-sm-8 my-10" :elevation="10">
                <v-carousel 
                  ...
                  cycle="true">
                    ...
                    <v-card>
                      ...
                      <v-card-title class="mx-0 my-0">{{ item.title }}</v-card-title>
                    </v-card>
                     </v-carousel-item>
