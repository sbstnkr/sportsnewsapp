      ...
      class="animated bounceIn">
        <v-row align="center">
          ...
          <v-col class="shrink">
            <v-btn
            icon
            @click="loadedOnce = false; overlay = false; secondModel = null; thirdModel = null; category = ''; team = ''; categories = []; teams = []; teamPlayers = null, selectedPlayer = null, teamEvents = null; animated = true; readMoreTeamDescActivated = false; image = require('@/assets/Soccer.jpeg'); placeholder = 'e.g. Lech Poznan'; icon = 'mdi-soccer'; selectedTeam = null">
              X
            </v-btn>
          </v-col>
        </v-row>
...
<!--             content-->
    <div class="indigo darken-1 text-center">
      ...
      gradient="to top left, rgba(100,115,201,.75), rgba(70,70,70,.85)">
        <v-card 
        :elevation="24" 
        color="rgba(26, 35, 126, 0.5)"
        class=" white--text col-md-8 col-sm-10 offset-md-2 offset-sm-1 my-md-10 my-5">

<!--             team info-->
          <div 
          class="Team_Info_container" 
          v-if="firstLoadOfPage!=true && selectedTeam">
...
<!--             banner section-->
            <img 
            v-if="selectedTeam.strTeamBanner" 
            :src="selectedTeam.strTeamBanner" 
            id="banner" 
            class="v-picker--full-width mb-5 animated fadeIn">

<!--             team description section-->
            <div 
            class="py-8 px-8" 
            v-if="selectedTeam.strDescriptionEN!=null" 
            data-aos="fade-up">
              ...
              v-if="!readMoreTeamDescActivated && isTeamDescToggleButton()" 
              @click="activateMoreText">
                Read More
              </v-btn>
              <v-btn 
              small 
              color="indigo lighten-4" 
              v-else-if="readMoreTeamDescActivated && isTeamDescToggleButton()" 
              @click="deactivateMoreText">
                Read Less
              </v-btn>
            </div>
            ...
            data-aos="fade-up">
              <v-row>
                ...
                style="margin-top: auto; margin-bottom: auto;">
                  <div 
                  v-for="(infoValue, infoKey) in teamInfo[0]" 
                  :key="infoKey">
...
<!--              team players section-->
            <v-card 
            v-if="teamPlayers" 
            class="text-left mx-sm-8 pa-0 my-10" 
            :elevation="10" 
            data-aos="fade-up">
              ...
              justify="space-between">
                <div 
                class="col-12 col-md-6 text-center pl-0" 
                style="margin-top: auto; margin-bottom: auto;">
                  <div 
                  v-if="!selectedPlayer" 
                  ...
                  class="animated flipInX">
                    <v-card-text>
                      <v-avatar size="100">
                        ...
                        <h3 class="headline mb-2">{{selectedPlayer.strPlayer}}</h3>
                    </v-card-text>
                    <v-divider></v-divider>
                    <div class="my-5">
                      <v-row 
                      v-if="selectedPlayer.dateBorn" 
                      class="pa-0">
                        <div 
                        class="offset-1 offset-md-0 col-5 pa-0 text-right font-regular mr-4 mb-2" 
                        tag="strong" 
                        cols="6">
                          Date of birth:
                        </div>
                      ...
                      <v-row 
                      v-if="selectedPlayer.strNationality" 
                      class="pa-0">
                        <div 
                        class="offset-1 offset-md-0 col-5 pa-0 text-right font-regular mr-4 mb-2" 
                        tag="strong" 
                      ...
                      <v-row 
                      v-if="selectedPlayer.strPosition" 
                      class="pa-0">
                        <div 
                        class="offset-1 offset-md-0 col-5 pa-0 text-right font-regular mr-4 mb-2" 
                        tag="strong" 
                      ...
                      <v-row class="justify-center">
                        <a 
                        v-if="selectedPlayer.strFacebook" 
                        target="_blank" 
                        v-bind:href="'http://' + selectedPlayer.strFacebook">
                          <i 
                          class="fab fa-facebook-square fa-2x social-icons" 
                          style="color: #153bd4;">
                          </i>
                        </a>
                        <a 
                        v-if="selectedPlayer.strTwitter" 
                        target="_blank" 
                        v-bind:href="'http://' + selectedPlayer.strTwitter">
                          <i 
                          class="fab fa-twitter-square fa-2x social-icons" 
                          style="color: #3ca5cf;">
                          </i>
                        </a>
                        <a 
                        v-if="selectedPlayer.strInstagram" 
                        target="_blank" 
                        v-bind:href="'http://' + selectedPlayer.strInstagram">
                          <i 
                          class="fab fa-instagram-square fa-2x social-icons" 
                          style="color: #bd31d6;">
                          </i>
                        </a>
                        <a 
                        v-if="selectedPlayer.strYoutube" 
                        target="_blank" 
                        v-bind:href="'http://' + selectedPlayer.strYoutube">
                          <i 
                          class="fab fa-youtube fa-2x social-icons" 
                          style="color: red;">
                          </i>
                        </a>
                      </v-row>
...
<!--              team events section-->
            <v-card 
            v-if="teamEvents" 
            class="col-sm-8 offset-sm-2 pa-0 my-10" 
            :elevation="10" 
            data-aos="fade-up">
              <v-toolbar 
                  ...
                  <template v-for="(teamEvent, eventIndex) in teamEvents">
                    ...
                    class="tooltip">
                      ...
                      <v-list-item-action>
                        ...
                        v-if="teamEvent.strTimeLocal!=null" 
                        v-text="teamEvent.strTimeLocal.slice(0,-3)">
                        </v-list-item-action-text>
                      </v-list-item-action>
                    </v-list-item>
